...
init()
{
    ...
    PrecacheMenu("dukip_map_selection2");
    //call this when your match 'ends'
    level thread onPlayerConnect();
    level waittill("gm_snipe_selected");
...
startMapVoting()
{
    ...
    for(i = 0; i < players.size; i++)
    {
        ...
        wait 0.05;
        players[i] OpenMenu("dukip_map_selection2");
    }
    wait 10;
...
generateTheMaps()
{
    ...
    mapList[3] = StrTok("mp_villa mp_radiation mp_firingrange", " ");
